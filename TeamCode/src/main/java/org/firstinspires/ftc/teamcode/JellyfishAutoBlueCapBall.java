...
@Autonomous(name="Jellyfish: Auto Blue Cap Ball", group="Jellyfish")

public class JellyfishAutoBlueCapBall extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(500);
        encoderDrive(DRIVE_SPEED,   0, 10 , 4.0);  // S2: Turn Right 12 Inches with 4 Sec timeout
//        sleep(500);
