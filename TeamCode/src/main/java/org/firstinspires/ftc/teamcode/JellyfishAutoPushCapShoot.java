...
@Autonomous(name="Jellyfish: Auto PushCapShoot", group="Jellyfish")

public class JellyfishAutoPushCapShoot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(100);
        encoderTurn(TURN_SPEED, 105, 4.0); // Turn left 90 degress
        sleep(100);
